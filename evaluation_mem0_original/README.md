...
> **Upstream evaluation harness — NOT part of the dreamfeed fork.**
>
...
> `evaluation/` to `evaluation_mem0_original/` so that no reader confuses it
> with fork-specific code. Numbers and code paths here refer to the original
> Mem0 paper ([arXiv:2504.19413](https://arxiv.org/abs/2504.19413)); the
> dreamfeed fork adds no evaluation harness of its own.
